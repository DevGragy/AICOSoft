...
<body>
    ...
    <main class="contenedor">
        ...
        <div class="contenedor-form">
            <form action="../model/register.php" method="POST" class="formulario">
    ...
    <footer class="footer-bg">
        <div class="footer-space">
            <div>
                ...
                <div>
                    <a href="https://wa.me/5215562533082" target="_blank">
                        <img src="../public/img/phone-ico.png" alt="Teléfono de contacto" class="icono-footer" /></a>
                ...
                <div>
                    <div class="espacio-footer">
                        <a href="https://gpoaico.com.mx/politica-de-privacidad/" target="_blank"><img
                                src="../public/img/doc-ico.png" alt="Aviso de privacidad" class="icono-footer" /></a>
                    ...
                    <div class="espacio-footer">
                        <a href="https://gpoaico.com.mx/terminosycondiciones/" target="_blank"><img
                                src="../public/img/doc-ico.png" alt="Términos y condiciones" class="icono-footer" /></a>
